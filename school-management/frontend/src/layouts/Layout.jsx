    ...
    >
        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
                <Link
                    to={"/"}
                    className="ml-5 px-3 py-1 rounded font-semibold bg-gray-600 text-white"                                        
                >
                    Dark mode
                </Link>
            </li>
            ...
            <main className={'container'}>
                <Outlet />{" "}
                {/** When you have nested routes, and you want to render the child routes within a parent component, you use the Outlet component as a placeholder where the child routes should be displayed. */}
            </main>
